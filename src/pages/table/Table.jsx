          ...
          <div className="search-header">
            <div className='flex'>
              <div className="table-search">
                ...
                <Button size='xs' view='clear' iconLeft={IconSearchStroked} className='search-icon' />
              </div>
              <Button label='Фильтры' iconLeft={IconSortDownCenter} size='xs' view='ghost' />
            </div>
            <Button label='Добавить' iconLeft={IconAdd} size='xs' view='primary' />
          </div>
          <div className="table-box">
            <Table zebraStriped="odd" rows={rows} columns={columns} />
            <div className='table-pagination'>
              <Text as='span' className='pagination-text' size='xs' view='ghost'>1 из 8</Text>
              <Pagination
                type="input"
                items={5}
                value={page}
